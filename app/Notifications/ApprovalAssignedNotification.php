...
final class ApprovalAssignedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('notifications.approval_assigned.subject'))
            ->line(__('notifications.approval_assigned.body'))
            ->action(
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'title' => __('notifications.approval_assigned.subject'),
            'body' => __('notifications.approval_assigned.body'),
